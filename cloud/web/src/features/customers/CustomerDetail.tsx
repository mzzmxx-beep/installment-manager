...
import { formatMoney, shortId, todayIso, toStorageAmount } from "@/lib/format";
            ...
            <Card key={sale.id}>
              <CardHeader>
                <CardTitle className="flex items-center justify-between text-sm font-medium">
                  <span>
                    فاتورة #{shortId(sale.id)} — {sale.sale_date} — {formatMoney(sale.total_installment_price, sale.currency_code)}
                  </span>
                  ...
                  {openSales.map((sale) => {
                    ...
                    return (
                      <option key={sale.id} value={sale.id}>
                        فاتورة #{shortId(sale.id)} — {sale.sale_date} — متبقي {formatMoney(remaining, sale.currency_code)}
                      </option>
                    );
                  })}
                </Select>
